...
def get_Value_to_csv(path_PM, path_Cloud, path_Satellite, path_ERA5, path_AUX, path_NDVI, path_result):
    ...
    writer = csv.writer(f)
    # 读取行列号数据
    # data_index = pd.read_csv(path_index)  
    # 读取ERA5数据
...
if __name__ == '__main__':
    ...
    path_ERA5 = 'C:/Users/Tiger/Desktop/ceshi/ERA5/2020_01_01.nc'
    ...
    path_Satellite = 'C:/Users/Tiger/Desktop/ceshi/H8'
    path_NDVI = 'C:/Users/Tiger/Desktop/ceshi/NDVI'
    path_result = 'C:/Users/Tiger/Desktop/result.csv'
